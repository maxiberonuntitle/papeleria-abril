  ...
  return (
    <Link to="/servicios" className="block group">
      <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl hover:shadow-[#d15739]/20 transform transition-all duration-500 hover:-translate-y-3 hover:scale-105 p-8 h-full border border-gray-100 hover:border-[#d15739]/20 relative overflow-hidden">
        ...
        <div className="absolute top-4 right-4 w-2 h-2 bg-[#eb833e]/20 rounded-full group-hover:scale-150 transition-transform duration-500" />
        <div className="absolute bottom-4 left-4 w-1 h-1 bg-[#d15739]/30 rounded-full group-hover:scale-200 transition-transform duration-500 delay-100" />
        
        <div className="relative z-10 flex flex-col items-center text-center">
          {/* Icono con efectos */}
          <div className="bg-gradient-to-br from-[#eb833e]/10 to-[#d15739]/10 p-4 rounded-2xl mb-6 group-hover:scale-110 group-hover:-rotate-3 transition-all duration-500">
